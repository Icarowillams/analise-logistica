...
import { 
  ...
  User, Calendar, ShoppingCart, Package, ArrowLeftRight, AlertTriangle
} from 'lucide-react';
import {
  Dialog,
  DialogContent,
...
export default function MeusRoteiros() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-0 shadow-lg">
        <CardHeader>
          <CardTitle className="text-base flex items-center gap-2">
            ...
            Clientes do Roteiro de Hoje ({clientesDoRoteiro.length})
          </CardTitle>
        </CardHeader>
        <CardContent>
          {clientesDoRoteiro.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-slate-500">Nenhum roteiro programado para hoje</p>
            </div>
          ) : (
      ...
      {/* Modal de Visita */}
      <Dialog open={!!clienteSelecionado} onOpenChange={handleFecharModal}>
          ...
          {clienteSelecionado && (
            <div className="space-y-4">
              ...
              <div className="p-3 bg-slate-50 rounded-lg text-sm">
                <p><strong>Código:</strong> {clienteSelecionado.codigo}</p>
