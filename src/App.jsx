...
import TransferirCarteira from './pages/TransferirCarteira.jsx';
...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/MetasTroca" element={<LayoutWrapper currentPageName="MetasTroca"><AnalisesComercial /></LayoutWrapper>} />
      <Route path="/metastroca" element={<LayoutWrapper currentPageName="MetasTroca"><AnalisesComercial /></LayoutWrapper>} />
      ...
      <Route path="/RelatorioCarregamento" element={<LayoutWrapper currentPageName="RelatorioCarregamento"><RelatorioCarregamento /></LayoutWrapper>} />
      ...
      <Route path="/TransferirCarteira" element={<LayoutWrapper currentPageName="TransferirCarteira"><TransferirCarteira /></LayoutWrapper>} />
