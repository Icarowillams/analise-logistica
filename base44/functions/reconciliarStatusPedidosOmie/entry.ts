...
// uma chave velha. A entidade ConfiguracaoOmie é apenas fallback (pode conter app_key/secret
// ANTIGO — por isso nunca tem prioridade). O antigo _credsCache + banco-primeiro causava
// "chave inválida" durante jobs de alta frequência.
