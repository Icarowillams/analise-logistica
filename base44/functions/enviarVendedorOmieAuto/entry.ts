...
// (preserva a classificação de erro existente). Registra circuit breaker em bloqueio/425.
...
Deno.serve(async (req) => {
    try {
        ...
        const resultado = await omieCall(base44, "geral/vendedores/", vendedorOmie, { call: "UpsertVendedor", skipLog: true });
